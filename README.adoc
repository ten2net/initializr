...
教程：(https://medium.com/@codespeaks/build-restful-services-with-spring-boot-2-x-in-few-steps-95c895a7abf5)[用SpringBoot2.x构建RESTful服务，只需几个步骤]

(https://github.com/letcodespeak/custsomer-service)[示例代码]
